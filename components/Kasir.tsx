            ...
            <div>
                <div className="border-b border-gray-200 bg-white rounded-t-xl">
                    <nav className="-mb-px flex space-x-6 px-6" aria-label="Tabs">
                        <button onClick={() => setActiveTab('Kasir')} className={`${activeTab === 'Kasir' ? 'border-blue-600 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'} flex items-center whitespace-nowrap py-4 px-1 border-b-2 font-semibold text-md`}>
                        ...
                        <button onClick={() => setActiveTab('Daftar Order')} className={`${activeTab === 'Daftar Order' ? 'border-blue-600 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'} flex items-center whitespace-nowrap py-4 px-1 border-b-2 font-semibold text-md`}>
                            ...
                            Daftar Order
                            {orders.length > 0 && <span className="ml-2.5 inline-flex items-center justify-center h-6 w-6 rounded-full bg-red-100 text-red-600 text-xs font-bold">{orders.length}</span>}
                        </button>
                    </nav>
                </div>
                                ...
                                <div className="overflow-x-auto rounded-lg border border-gray-200">
                                    <table className="min-w-full bg-white text-sm">
                                        <thead className="bg-gray-50">
                                            <tr>
                                                <th className="py-3 px-4 text-left font-semibold text-gray-600">No. Bon</th>
                                                <th className="py-3 px-4 text-left font-semibold text-gray-600">Customer</th>
                                                <th className="py-3 px-4 text-left font-semibold text-gray-600">Tanggal</th>
                                                <th className="py-3 px-4 text-left font-semibold text-gray-600">Metode Bayar</th>
                                        ...
                                        <tbody className="divide-y divide-gray-200">
                                            {orders.map((order) => (
                                                <tr key={order.id} className="hover:bg-gray-50">
                                                    <td className="py-3 px-4 whitespace-nowrap text-gray-700 font-medium">{order.bon}</td>
                                                    <td className="py-3 px-4 whitespace-nowrap text-gray-700">{order.customer}</td>
                                                    <td className="py-3 px-4 whitespace-nowrap text-gray-500">{order.date}</td>
                                                    <td className="py-3 px-4 whitespace-nowrap text-gray-500">{order.paymentMethod}</td>
                                                    <td className="py-3 px-4 whitespace-nowrap text-gray-800 text-right font-medium">{formatRupiah(order.grandTotal)}</td>
                                                    ...
                                                    <td className="py-3 px-4 whitespace-nowrap text-center"><button onClick={() => handleShowOrderDetail(order)} className="text-blue-600 hover:text-blue-800 font-medium text-xs">Detail</button></td>
                                                </tr>
                                            ))}
                                        </tbody>
                                    </table>
