...
const DropdownItem: React.FC<{ icon: ReactNode; onClick: () => void; children: ReactNode; isActive?: boolean }> = ({ icon, onClick, children, isActive }) => (
    <button
        onClick={onClick}
        className={`w-full flex items-center text-left px-3 py-2 rounded-md text-sm transition-colors duration-150 group ${
            isActive
...
const DropdownDivider: React.FC = () => <div className="h-px bg-gray-200 my-1" />;
                ...
                <div className="flex justify-between items-center h-full">
                    <div className="flex items-center gap-6">
                         <div className="flex items-center space-x-3">
                            ...
                            <span className="text-xl font-bold text-gray-800 tracking-tight">InfinityPOS</span>
                        </div>
                    ...
                    <div className="flex items-center gap-2">
                        <div className="relative" ref={notificationPanelRef}>
                            <button 
                                ...
                                className="relative p-2 rounded-full text-gray-500 hover:bg-gray-100 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500" 
                        ...
                        <button onClick={() => onNavigate('Settings')} className="p-2 rounded-full text-gray-500 hover:bg-gray-100 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500" aria-label="Settings">
                        ...
                        <div className="relative" ref={ownerMenuRef}>
                            <button 
                                ...
                                className="w-10 h-10 bg-gray-200 rounded-full flex items-center justify-center text-gray-600 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 overflow-hidden"
                                aria-haspopup="true"
                            ...
                            {isOwnerMenuOpen && (
                                <div className="absolute right-0 mt-2 w-72 origin-top-right bg-white rounded-xl shadow-xl z-30 ring-1 ring-black ring-opacity-5 focus:outline-none overflow-hidden">
                                    <div className="p-2">
                                        <div className="flex items-center gap-3 p-2 border-b border-gray-200 mb-1">
                                            ...
                                            <div>
                                                <p className="text-md font-semibold text-gray-900 truncate">{storeName}</p>
                                        ...
                                        <button
                                            ...
                                            className="w-full flex items-center text-left px-3 py-2 rounded-md text-sm transition-colors duration-150 group text-red-600 hover:bg-red-50"
                                        >
