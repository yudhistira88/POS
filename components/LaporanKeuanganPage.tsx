        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <StatCard 
                    ...
                    change={financialSummary.labaBersih > 0 ? '+25.7%' : '-10.2%'}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
                ...
                <div className="lg:col-span-2 grid grid-cols-1 gap-6">
                     <TransactionTable title="Detail Pendapatan" items={financialSummary.allIncomes} type="income" />
                     <TransactionTable title="Detail Pengeluaran" items={financialSummary.filteredExpenses} type="expense" />
                </div>
            </div>
        </div>
    );
