                        ...
                        <table className="min-w-full bg-white text-sm">
                            ...
                            <tbody className="divide-y divide-gray-200">
                                {combinedTransactions.map((tx) => (
                                    <tr key={`${tx.type}-${tx.id}`} className="hover:bg-gray-50">
                                        ...
                                        <td className={`py-4 px-6 whitespace-nowrap text-right font-semibold ${tx.type === 'income' ? 'text-emerald-600' : 'text-rose-600'}`}>
                         ...
                         {combinedTransactions.length === 0 && (
                             <div className="text-center py-16 text-gray-500">
                                <h3 className="text-lg font-semibold text-gray-700">Belum Ada Transaksi</h3>
